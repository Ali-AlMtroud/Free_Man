...
import 'package:free_man/features/auth/widgets/decoration_functions.dart';
import 'package:free_man/features//auth/widgets/sign_in_up_bar.dart';
...
class _SignInState extends State<SignIn> {
  ...
  void _saveAndRedirectToHome(User user) async {
    ...
    await pref.setString('name', user.Fname??"");
    await pref.setString('name', user.Lname??"");
